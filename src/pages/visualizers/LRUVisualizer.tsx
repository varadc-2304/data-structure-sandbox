    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="page-container pt-20">
        <div className="mb-6 animate-slide-in">
          ...
          <h1 className="text-3xl font-bold text-arena-dark mb-2">Least Recently Used (LRU)</h1>
          <p className="text-arena-gray text-sm">Visualize the LRU page replacement algorithm. The page that hasn't been used for the longest time is replaced when a new page is needed.</p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="md:col-span-3">
                <div className="bg-white rounded-2xl shadow-md p-4 animate-scale-in text-sm" style={{ animationDelay: "0.4s" }}>
                  <h2 className="text-lg font-semibold mb-2">About Least Recently Used</h2>
                  <p className="text-arena-gray mb-3 text-sm">LRU (Least Recently Used) is an optimal page replacement algorithm that replaces the page that hasn't been accessed for the longest time. It performs well but requires tracking page access history.</p>
