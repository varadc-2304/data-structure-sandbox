...
import LRUControls from "./lru/LRUControls";
import LRUVisualization from "./lru/LRUVisualization";
import LRUStats from "./lru/LRUStats";
import LRUAlgorithmInfo from "./lru/LRUAlgorithmInfo";
import { useLRUVisualizer } from "./lru/useLRUVisualizer";
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="page-container pt-20">
        <div className="mb-6 animate-slide-in">
          ...
          <h1 className="text-3xl font-bold text-foreground mb-2">Least Recently Used (LRU)</h1>
          <p className="text-muted-foreground text-sm">Visualize the LRU page replacement algorithm. The page that hasn't been used for the longest time is replaced when a new page is needed.</p>
        </div>
        ...
        <Tabs defaultValue="visualizer" className="w-full">
          ...
          <TabsContent value="visualizer" className="mt-0">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="md:col-span-1">
                ...
                <div className="mt-4">
                  <LRUStats pageFaults={pageFaults} pageHits={pageHits} referenceHistory={referenceHistory} />
                </div>
              </div>
              ...
              <div className="md:col-span-3">
                <div className="bg-card rounded-2xl shadow-md p-4 animate-scale-in text-sm border border-border" style={{ animationDelay: "0.4s" }}>
                  <h2 className="text-lg font-semibold mb-2 text-foreground">About Least Recently Used</h2>
                  <p className="text-muted-foreground mb-3 text-sm">LRU (Least Recently Used) is an optimal page replacement algorithm that replaces the page that hasn't been accessed for the longest time. It performs well but requires tracking page access history.</p>
                    ...
                    <Card className="bg-secondary">
                      ...
                      <CardContent className="py-2 px-3">
                        <ul className="list-disc pl-4 text-muted-foreground space-y-1">
                          ...
                          <li>Considers temporal locality</li>
                    ...
                    <Card className="bg-secondary">
                      ...
                      <CardContent className="py-2 px-3">
                        <ul className="list-disc pl-4 text-muted-foreground space-y-1">
                          ...
                          <li>May need hardware support</li>
                        </ul>
                      </CardContent>
                    </Card>
                  </div>
          ...
          <TabsContent value="algorithm" className="mt-0">
            <div className="bg-card rounded-lg border border-border shadow-lg p-6 md:p-8">
              <LRUAlgorithmInfo type="algorithm" />
            </div>
          </TabsContent>
        </Tabs>
      </div>
