    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="page-container pt-20">
        <div className="mb-6 animate-slide-in">
          ...
          <h1 className="text-3xl font-bold text-arena-dark mb-2">Most Recently Used (MRU)</h1>
          <p className="text-arena-gray text-sm">Visualize the MRU page replacement algorithm. The most recently used page is replaced when a new page is needed.</p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="md:col-span-3">
                <div className="bg-white rounded-2xl shadow-md p-4 animate-scale-in text-sm" style={{ animationDelay: "0.4s" }}>
                  <h2 className="text-lg font-semibold mb-2">About Most Recently Used</h2>
                  <p className="text-arena-gray mb-3 text-sm">MRU (Most Recently Used) is a page replacement algorithm that replaces the most recently used page. It's useful in specific scenarios with certain access patterns.</p>
