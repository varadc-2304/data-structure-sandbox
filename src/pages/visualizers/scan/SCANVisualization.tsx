...
import { DiskRequest, SeekOperation } from "./useSCANVisualizer";
...
interface SCANVisualizationProps {
  ...
  currentStep: number;
  scanOrder: (number | "boundary")[];
  seekHistory: SeekOperation[];
  direction: "left" | "right";
  isMovingToEdge: boolean;
    ...
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          ...
          {isMovingToEdge && <Badge className="ml-2 bg-primary">Moving to Edge</Badge>}
        </CardDescription>
      </CardHeader>
      <CardContent>
        <div className="mb-6">
          ...
          <div className="relative bg-gradient-to-r from-secondary to-card rounded-xl border-2 border-border p-6 overflow-hidden" style={{ minHeight: "180px" }}>
            ...
            <div className="absolute top-4 right-4 flex items-center space-x-2">
              ...
              <Badge variant="outline" className="bg-primary/10 text-blue-600 border-blue-300">
        ...
        <div className="mb-6">
          <h3 className="text-sm font-medium text-foreground mb-2">SCAN Order</h3>
