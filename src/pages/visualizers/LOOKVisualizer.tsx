    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="page-container pt-20">
        <div className="mb-6 animate-slide-in">
          ...
          <h1 className="text-3xl font-bold text-arena-dark mb-2">LOOK Algorithm</h1>
          <p className="text-arena-gray text-sm">Visualize the LOOK disk scheduling algorithm. Improved SCAN that only goes as far as the last request in each direction, reducing unnecessary movement.</p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="md:col-span-3">
                <div className="bg-white rounded-2xl shadow-md p-4 animate-scale-in text-sm" style={{ animationDelay: "0.4s" }}>
                  <h2 className="text-lg font-semibold mb-2">About LOOK Algorithm</h2>
                  <p className="text-arena-gray mb-3 text-sm">LOOK is an improved version of SCAN that only goes as far as the last request in each direction, reducing unnecessary head movement.</p>
