                    ...
                    <div className="mb-6">
                      ...
                      <div className="relative bg-drona-light rounded-lg p-8 border-2 border-gray-200" style={{ minHeight: "120px" }}>
                        ...
                        <div className="absolute top-4 right-8">
                          <div className="flex items-center gap-2 bg-white px-3 py-1 rounded-full border-2 border-drona-green">
                            <span className="text-sm font-medium text-drona-green">Direction: Upward</span>
                            <span className="text-drona-green">→</span>
                          </div>
                        </div>
