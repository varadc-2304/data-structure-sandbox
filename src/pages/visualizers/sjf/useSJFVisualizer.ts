...
export const useSJFVisualizer = () => {
  ...
  const runSimulation = () => {
    ...
    const { ganttChart: newGanttChart, scheduledProcesses: newScheduledProcesses } = isPreemptive ? runSJFPreemptive(processes) : runSJFNonPreemptive(processes);
