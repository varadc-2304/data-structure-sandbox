...
export const usePriorityVisualizer = () => {
  ...
  const runSimulation = () => {
    ...
    const { ganttChart: newGanttChart, scheduledProcesses: newScheduledProcesses } = isPreemptive ? runPriorityPreemptive(processes) : runPriorityNonPreemptive(processes);
