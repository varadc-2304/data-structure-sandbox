import { Plus, Trash, Play, RotateCcw, ArrowLeft, ArrowRight, Sparkles } from "lucide-react";
...
interface BinaryTreeControlsProps {
  ...
  traversalType: "inorder" | "preorder" | "postorder" | null;
        ...
        <div className="bg-arena-light rounded-xl p-4">
          ...
          <div className="space-y-2">
            <Input
              ...
              className="focus:ring-arena-green focus:border-arena-green text-sm"
            />
      ...
      <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-arena-light rounded-xl p-4">
          ...
          <div className="space-y-2">
            <select
              value={parentNode}
              onChange={(e) => onParentNodeChange(e.target.value)}
            ...
            <select
              value={childNode}
              onChange={(e) => onChildNodeChange(e.target.value)}
              className="w-full px-2 py-1.5 border border-gray-300 rounded text-sm bg-white"
            >
            ...
            <div className="flex gap-2">
              <Button
                onClick={() => onChildPositionChange("left")}
              ...
              <Button
                onClick={() => onChildPositionChange("right")}
        ...
        <div className="bg-arena-light rounded-xl p-4">
          <h3 className="text-base font-medium mb-3">Traversal Status</h3>
          <div className="text-sm text-arena-gray">
            {isTraversing ? (
              <div className="space-y-1">
                <span className="text-arena-green block">Running {traversalType} traversal...</span>
