...
import { PageFrame, ReferenceHistory } from "./useMRUVisualizer";

interface MRUVisualizationProps {
...
const MRUVisualization = ({ pageReferences, currentStep, frames, referenceHistory }: MRUVisualizationProps) => {
  return (
    <div>
        <div className="mb-4">
...
export default MRUVisualization;
