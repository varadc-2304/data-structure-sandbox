...
import { DiskRequest, SeekOperation } from "./useCLOOKVisualizer";

interface CLOOKVisualizationProps {
  diskSize: number;
...
export default CLOOKVisualization;
