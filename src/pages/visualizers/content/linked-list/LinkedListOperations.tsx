  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 w-full">
    <div className="bg-secondary rounded-xl p-4 border border-border w-full min-w-0">
      ...
      <div className="flex gap-2">
        ...
        />
        <Button onClick={insertAtHead} variant="default" size="sm" className="flex-shrink-0">
          Insert
        </Button>
      </div>
    </div>
    ...
    <div className="bg-secondary rounded-xl p-4 border border-border w-full min-w-0">
      ...
      <div className="flex gap-2">
        <input
          ...
          className="flex-1 min-w-0 px-3 py-2 border border-input rounded-md bg-background text-foreground focus:outline-none focus:ring-2 focus:ring-ring text-sm"
        />
        <Button onClick={insertTail} variant="default" size="sm" className="flex-shrink-0">
          Insert
        </Button>
      </div>
    </div>
    ...
    <div className="bg-secondary rounded-xl p-4 border border-border w-full min-w-0">
      ...
      <div className="space-y-2">
        ...
        <input
          ...
          className="w-full px-3 py-2 border border-input rounded-md bg-background text-foreground focus:outline-none focus:ring-2 focus:ring-ring text-sm"
        />
        <Button onClick={insertAtPosition} variant="default" size="sm" className="w-full">
          Insert
        </Button>
      </div>
    </div>
    ...
    <div className="bg-secondary rounded-xl p-4 border border-border w-full min-w-0">
      ...
      <Button onClick={deleteHead} variant="default" size="sm" className="w-full">
        Delete Head
      </Button>
    </div>
    ...
    <div className="bg-secondary rounded-xl p-4 border border-border w-full min-w-0">
      ...
      <Button onClick={deleteTail} variant="default" size="sm" className="w-full">
        Delete Tail
      </Button>
    </div>
  </div>
