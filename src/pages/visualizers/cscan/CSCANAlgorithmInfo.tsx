...
interface CSCANAlgorithmInfoProps {
  type: "algorithm" | "performance";
}

const CSCANAlgorithmInfo = ({ type }: CSCANAlgorithmInfoProps) => {
  if (type === "algorithm") {
    return (
        ...
        <div className="space-y-8">
          ...
          <div className="border-b border-border pb-6">
            ...
            <p className="text-base text-muted-foreground leading-relaxed max-w-4xl">
              C-SCAN is an improved version of the SCAN algorithm. The disk arm moves in one direction, servicing all requests, then immediately returns to the starting end without servicing requests on the return trip.
            </p>
          </div>
            ...
            <CardContent>
              <ul className="space-y-3 text-sm text-foreground">
                <li className="flex items-start gap-3">
                  ...
                  <span className="flex-1">Moves in one direction serving all requests</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="flex-shrink-0 w-5 h-5 rounded-full bg-primary/20 text-primary font-semibold flex items-center justify-center text-xs mt-0.5">•</span>
                  <span className="flex-1">Returns to beginning immediately after reaching end</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="flex-shrink-0 w-5 h-5 rounded-full bg-primary/20 text-primary font-semibold flex items-center justify-center text-xs mt-0.5">•</span>
                  <span className="flex-1">Provides more uniform wait times than SCAN</span>
                </li>
              </ul>
            </CardContent>
          </Card>
              ...
              <CardContent className="p-5">
                <ol className="space-y-4 text-sm text-foreground">
                  ...
                  <li className="flex items-start gap-4">
                    ...
                    <span className="flex-1 pt-1">Jump to beginning of disk without servicing</span>
                  </li>
                  <li className="flex items-start gap-4">
                    ...
                    <span className="flex-1 pt-1">Service remaining requests from the beginning</span>
                  </li>
                </ol>
              </CardContent>
            </Card>
...
{`CSCAN_DiskScheduling(requestQueue, initialHeadPosition, direction):
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <Card className="bg-secondary/50 border-border shadow-sm hover:shadow-md transition-shadow">
                ...
                <CardContent>
                  <p className="text-sm font-medium text-primary">Jump from end to beginning without servicing</p>
                </CardContent>
              </Card>
            </div>
          </div>
                ...
                <CardContent>
                  <ul className="space-y-2.5 text-sm text-foreground">
                    <li className="flex items-start gap-2.5">
                      ...
                      <span>More uniform wait time compared to SCAN</span>
                    </li>
                    <li className="flex items-start gap-2.5">
                      <span className="text-green-600 dark:text-green-400 font-bold mt-0.5 text-base">•</span>
                      <span>Provides better performance than FCFS and SCAN</span>
                    </li>
                    <li className="flex items-start gap-2.5">
                      <span className="text-green-600 dark:text-green-400 font-bold mt-0.5 text-base">•</span>
                      <span>Reduces the possibility of starvation</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
                ...
                <CardContent>
                  <ul className="space-y-2.5 text-sm text-foreground">
                    <li className="flex items-start gap-2.5">
                      ...
                      <span>Longer seek times compared to SSTF</span>
                    </li>
                    <li className="flex items-start gap-2.5">
                      <span className="text-red-600 dark:text-red-400 font-bold mt-0.5 text-base">•</span>
                      <span>Not as efficient as LOOK or C-LOOK</span>
                    </li>
                    <li className="flex items-start gap-2.5">
                      <span className="text-red-600 dark:text-red-400 font-bold mt-0.5 text-base">•</span>
                      <span>Head movement to end and back without servicing</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
          ...
          <Card className="bg-gradient-to-br from-blue-50 to-blue-100/50 dark:from-blue-950/30 dark:to-blue-900/20 border-blue-200 dark:border-blue-800 shadow-md">
            ...
            <CardContent>
              <ul className="space-y-2.5 text-sm text-foreground">
                ...
                <li className="flex items-start gap-2.5">
                  <span className="text-blue-600 dark:text-blue-400 font-bold mt-0.5 text-base">•</span>
                  <span>Applications where fairness is critical</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <span className="text-blue-600 dark:text-blue-400 font-bold mt-0.5 text-base">•</span>
...
export default CSCANAlgorithmInfo;
