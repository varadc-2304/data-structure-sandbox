...
import { DiskRequest, SeekOperation } from "./useCSCANVisualizer";

interface CSCANVisualizationProps {
  diskSize: number;
...
export default CSCANVisualization;
