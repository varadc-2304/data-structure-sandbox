    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="page-container pt-32">
        <div className="mb-10 animate-slide-in">
          ...
          <h1 className="text-4xl font-bold text-arena-dark mb-2">Shortest Job First (SJF)</h1>
        ...
        <div className="grid grid-cols-1 gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-md p-6 animate-scale-in" style={{ animationDelay: "0.4s" }}>
            <h2 className="text-xl font-semibold mb-2">About Shortest Job First</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
              <Card className="bg-arena-light">
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm font-medium">Non-preemptive SJF</CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card className="bg-arena-light">
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm font-medium">Preemptive SJF (SRTF)</CardTitle>
                </CardHeader>
                <CardContent>
                  <ul className="list-disc pl-5 text-arena-gray space-y-1">
