...
import { SeekOperation } from "./useLOOKVisualizer";

interface LOOKStatsProps {
  totalSeekTime: number;
  seekHistory: SeekOperation[];
  currentHeadPosition: number;
}

const LOOKStats = ({ totalSeekTime, seekHistory, currentHeadPosition }: LOOKStatsProps) => {
  return (
    <Card>
      <CardHeader>
