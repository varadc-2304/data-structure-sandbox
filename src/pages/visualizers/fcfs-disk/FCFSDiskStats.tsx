...
import { SeekOperation } from "./useFCFSDiskVisualizer";

interface FCFSDiskStatsProps {
  totalSeekTime: number;
  seekHistory: SeekOperation[];
  currentHeadPosition: number;
}

const FCFSDiskStats = ({ totalSeekTime, seekHistory, currentHeadPosition }: FCFSDiskStatsProps) => {
  return (
    <Card>
      <CardHeader>
