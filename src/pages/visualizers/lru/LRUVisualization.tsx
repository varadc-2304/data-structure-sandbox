...
import { PageFrame, ReferenceHistory } from "./useLRUVisualizer";
...
const LRUVisualization = ({ pageReferences, currentStep, frames, referenceHistory }: LRUVisualizationProps) => {
  return (
    <div>
        <div className="mb-4">
