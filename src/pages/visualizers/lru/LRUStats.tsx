...
import { ReferenceHistory } from "./useLRUVisualizer";

interface LRUStatsProps {
  pageFaults: number;
  pageHits: number;
  referenceHistory: ReferenceHistory[];
}

const LRUStats = ({ pageFaults, pageHits, referenceHistory }: LRUStatsProps) => {
