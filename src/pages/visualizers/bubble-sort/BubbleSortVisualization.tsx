  ...
  return (
    <Card className="shadow-lg border-2 border-drona-green/20 h-full">
      <CardHeader className="bg-gradient-to-r from-drona-green/5 to-drona-green/10">
        <CardTitle className="text-2xl font-bold text-drona-dark">Bubble Sort Visualization</CardTitle>
      </CardHeader>
            ...
            <div className="flex items-end justify-center gap-2 min-h-[200px]">
              {array.map((value, index) => {
                ...
                return (
                  <div
                    key={index}
                    className={`w-10 sm:w-12 flex flex-col items-center justify-end transition-all duration-200 rounded-md border-2 ${
                      isSorted
