...
import { SeekOperation } from "./useSSTFVisualizer";

interface SSTFStatsProps {
  totalSeekTime: number;
  seekHistory: SeekOperation[];
  currentHeadPosition: number;
}

const SSTFStats = ({ totalSeekTime, seekHistory, currentHeadPosition }: SSTFStatsProps) => {
  return (
    <Card>
      <CardHeader>
