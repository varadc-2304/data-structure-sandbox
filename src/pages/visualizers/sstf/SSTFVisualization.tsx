...
import { DiskRequest, SeekOperation } from "./useSSTFVisualizer";

interface SSTFVisualizationProps {
  diskSize: number;
  ...
  return (
    <Card>
      ...
      <CardContent>
        ...
        <div className="mb-6">
          <h3 className="text-sm font-medium text-foreground mb-2">SSTF Order (Shortest Seek Time First)</h3>
...
export default SSTFVisualization;
