...
const BinarySearchVisualizer = () => {
  ...
  const [searchSteps, setSearchSteps] = useState<Array<{left: number, right: number, mid: number, comparison: string}>>([]);
  ...
  const calculateSearchSteps = (arr: number[], target: number) => {
    const steps: Array<{left: number, right: number, mid: number, comparison: string}> = [];
    let low = 0;
