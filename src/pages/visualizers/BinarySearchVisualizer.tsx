...
import BinarySearchControls from "./binary-search/BinarySearchControls";
import BinarySearchVisualization from "./binary-search/BinarySearchVisualization";
import { useBinarySearchVisualizer } from "./binary-search/useBinarySearchVisualizer";
    ...
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl pt-20 pb-12">
        <div className="mb-6">
          ...
          <h1 className="text-3xl font-bold text-foreground mb-2">Binary Search</h1>
          <p className="text-muted-foreground text-sm">Binary search efficiently finds elements in sorted arrays by dividing the search space in half.</p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="md:col-span-2">
                <div className="bg-card rounded-lg border border-border p-4">
                  ...
                  <div className="mb-4">
                    ...
                    <BinarySearchVisualization array={array} left={left} right={right} mid={mid} searchValue={searchValue} />
                  </div>
              ...
              <div className="md:col-span-3">
                <div className="bg-card rounded-lg border border-border p-4 text-sm">
                  <h2 className="text-lg font-semibold mb-2">About Binary Search</h2>
                  <p className="text-muted-foreground mb-3 text-sm">Binary search is an efficient searching algorithm that works on sorted arrays by repeatedly dividing the search space in half.</p>
                  ...
                  <CardContent>
                    <ul className="space-y-3 text-sm text-foreground">
                      <li className="flex items-start gap-3">
                        ...
                        <span className="flex-1">Compare target with middle element</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="flex-shrink-0 w-5 h-5 rounded-full bg-primary/20 text-primary font-semibold flex items-center justify-center text-xs mt-0.5">•</span>
                        <span className="flex-1">If target matches, return the index</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="flex-shrink-0 w-5 h-5 rounded-full bg-primary/20 text-primary font-semibold flex items-center justify-center text-xs mt-0.5">•</span>
                        <span className="flex-1">If target is smaller, search left half</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="flex-shrink-0 w-5 h-5 rounded-full bg-primary/20 text-primary font-semibold flex items-center justify-center text-xs mt-0.5">•</span>
                        <span className="flex-1">If target is larger, search right half</span>
                      </li>
                    </ul>
                  </CardContent>
                </Card>
                    ...
                    <CardContent className="p-5">
                      <ol className="space-y-4 text-sm text-foreground">
                        <li className="flex items-start gap-4">
                          ...
                          <span className="flex-1 pt-1">Set left = 0 and right = array.length - 1</span>
                        </li>
                        <li className="flex items-start gap-4">
                          ...
                          <span className="flex-1 pt-1">While left ≤ right, calculate mid = (left + right) / 2</span>
                        </li>
                        <li className="flex items-start gap-4">
                          ...
                          <span className="flex-1 pt-1">If array[mid] == target, return mid</span>
                        </li>
                        <li className="flex items-start gap-4">
                          ...
                          <span className="flex-1 pt-1">If array[mid] &lt; target, set left = mid + 1</span>
                        </li>
                        <li className="flex items-start gap-4">
                          ...
                          <span className="flex-1 pt-1">If array[mid] &gt; target, set right = mid - 1</span>
                        </li>
                        <li className="flex items-start gap-4">
                          ...
                          <span className="flex-1 pt-1">If loop ends, return -1 (not found)</span>
                        </li>
                      </ol>
                    </CardContent>
                  </Card>
